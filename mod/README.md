...
All districts respond to changes in civics that alter jobs.  For example, Leisure Districts trade a Culture Worker for Priests for spiritualists (or Dealth Priest for death cults), and/or trade an Entertainer for a Duelist with Warrior Culture.
